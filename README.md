...
- When exporting some .nsk or .map files the game tends to crash? The cause of this I can't seem to figure out, I recommend for big changes rather than using the file generated by the exporter, to copy over the changes done to the original file instead
